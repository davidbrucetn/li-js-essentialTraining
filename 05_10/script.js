...
const navBarContent = `
    <ul class="nav__ul">
      <li class="nav-item home"><a href="#document-top">Home</li>
      <li class="nav-item about"><a href="#about">About</li>
      <li class="nav-item purpose"><a href="#purpose">Purpose</li>
      <li class="nav-item contact"><a href="#contact">Contact</li>
      <li class="nav-item course"><a href="#course">Course Footer</li>
    </ul>
`;
...
siteNav.innerHTML = navBarContent


document.querySelector(".siteheader").prepend(siteNav)
